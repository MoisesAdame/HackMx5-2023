                        ...
                        <div class="row">
                              ...
                              <div class="col-xs-12">
                                    <div class="hidden alert alert-success alert-dismissible"  id="registerAlertSuccess">
                                          ...
                                          <strong>Revisa tu correo!</strong> Te hemos reenviado el mail.[Checa spam :/]
                                    </div>
                              ...
                              <div class="col-xs-12">
                                  <div class="row">
                                    <h1 style="color: #fff">Hemos cerrado el registro, te esperamos en HackMx 2020</h1>
                                    <h2 style="color: #fff">Si te registraste y no te llegó correo de confirmación por favor ingresa el correo con el que te registraste.</h2>
                                  </div>
